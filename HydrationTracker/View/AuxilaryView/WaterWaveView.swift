...
extension WaterWaveView{
    private func setupViews() {
        ...
        firstColor = .white
        secondColor = UIColor(named: "waterColor")!
    ...
    func setupProgress(_ pr: CGFloat,finalValue:CGFloat){
        
        
        progress = pr
        percentLbl.text = String(format: "%ld% ml", NSNumber(value: Float(pr*finalValue)).intValue)
